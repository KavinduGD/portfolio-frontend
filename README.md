...
<img src="assets/architecture-diagram.png" alt="System Workflow" width="800px"/>
...
3.  **Set up environment variables**:
    Create a `.env` file based on `.env.example` (if available) or configure the necessary VITE\_ variables.
